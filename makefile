...
test1: src/test1.c ${OBJECT_MERGE}
	${CC} ${OBJECT_MERGE} src/test1.c -o tests/test1/program ${CFLAGS}


test2: src/test2.c ${OBJECT_MERGE}
	${CC} ${OBJECT_MERGE} src/test2.c -o tests/test2/program ${CFLAGS}


test3: src/test3.c ${OBJECT_MERGE}
	${CC} ${OBJECT_MERGE} src/test3.c -o tests/test3/program ${CFLAGS}


test4: src/test4.c ${OBJECT_MERGE}
	${CC} ${OBJECT_MERGE} src/test4.c -o tests/test4/program ${CFLAGS}


test5: src/test5.c ${OBJECT_MERGE}
	${CC} ${OBJECT_MERGE} src/test5.c -o tests/test5/program ${CFLAGS}


test6: src/test6.c ${OBJECT_MERGE}
	${CC} ${OBJECT_MERGE} src/test6.c -o tests/test6/program ${CFLAGS}
